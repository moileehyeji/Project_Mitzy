...
def build_model(acti, opti, lr):    
    ...
    x = Conv1D(filters=150,kernel_size=2,padding='same',strides = 2, activation=acti)(x)
    x = Dropout(0.3)(x)
    # x = MaxPooling1D(pool_size=2)(x)
    x = Conv1D(filters=150,kernel_size=2,padding='same',strides = 2, activation=acti)(x)
    x = Dropout(0.3)(x)
...
#3. 훈련
modelpath =f"./mitzy/data/hdf5/10_conv1d_5_{acti}_Nadam.hdf5"
...
# (177408, 1)
# (177408,)
# r2 :  0.6190954989744908
# rmse :  2.3955217234692148
# mae :  0.7318909381850405
# mse :  5.738524327612917
# 10_conv1d_5_swish_Nadam.hdf5
