...
for op_idx,opti in enumerate(opti_list):
    for ac_idx,acti in enumerate(acti_list):
        modelpath = f'./mitzy/data/modelcheckpoint/25_deltime_data_conv1dd_{op_idx}_{ac_idx}.hdf5'
        ...
        df.to_csv(f'./mitzy/data/csv/25_deltime_data_conv1d_{op_idx}_{ac_idx}.csv',index=False)
